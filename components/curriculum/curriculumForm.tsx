import { Avatar, Box, Button, Card, CardActions, CardContent, CardHeader, Fab, FormControl, FormControlLabel, FormLabel, Grid, IconButton, List, ListItem, ListItemAvatar, ListItemText, Paper, Radio, RadioGroup, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TextField, Typography, capitalize, styled } from '@mui/material'
...
const rows = [
    createData('Tel.', '+159 993 3894 38'),
    createData('Email', 'juan@email.com'),
    createData('From', 'La Habana, Cuba'),
    ...
    return (
        <Box display='flex' flexDirection={'column'}  >
            ...
            <Grid container sx={{ width: '100vw', padding: '0px 40px', paddingTop: '90px', justifyContent: 'center', margin: '60px 0px' }} >
                <Grid xs={12} sm={6} sx={{ height: '100%', display: 'flex', alignItems: 'center', justifyContent: { xs: 'center', sm: 'flex-end' }, marginBottom: '15px' }}>
                    <Image src={'/../../static/user/profile.jpg'} alt='User Profile Image'
                        style={{
                            width: '32vw',
                            height: '35vw',
                            objectFit: 'contain',
                ...
                <Grid xs={12} sm={6} sx={{ textAlign: { xs: 'center', sm: 'initial' }, display: 'flex', justifyContent: { xs: 'center', sm: 'initial' }, alignItems: 'center' }}  >
                    <Grid width={'80vw'}>
            ...
            <Grid container sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, alignItems: 'center', width: '100vw', padding: '0px 6vw', margin: '60px 0px' }} >
                <Grid item xs={12} sm={6} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }} >
                    ...
                    <Typography padding={'45px'} >
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus deserunt quasi ipsam qui laudantium error libero,
